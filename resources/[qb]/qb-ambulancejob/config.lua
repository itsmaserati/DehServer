...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ...
    -- },
    ["armory"] = {
        [1] = vector4(310.44, -602.96, 43.28, 63.8),
    ...
    ["main"] = {
        [1] = vector3(327.2, -603.65, 43.28),
    },
    ["basement"] = {
        [1] = vector3(340.12, -584.7, 28.8),
    },
    ["stash"] = {
        [1] = vector3(0, 0, 0),
    },
    ["beds"] = {
        --Pillbox
        [1] = {coords = vector4(319.41, -581.04, 42.84, 160.0), taken = false, model = 1631638868},
        [2] = {coords = vector4(324.26, -582.8, 42.84, 160.0), taken = false, model = 1631638868},
        [3] = {coords = vector4(322.62, -587.17, 42.84, 340.0), taken = false, model = 1631638868},
        ...
        [6] = {coords = vector4(311.06, -582.96, 42.84, 340.0), taken = false, model = 1631638868},
        [7] = {coords = vector4(307.72, -581.75, 42.84, 340.0), taken = false, model = 1631638868},
        [8] = {coords = vector4(309.35, -577.38, 42.84, 160.0), taken = false, model = 1631638868},
        [9] = {coords = vector4(313.93, -579.04, 42.84, 160.0), taken = false, model = 1631638868},
	--- paleto
