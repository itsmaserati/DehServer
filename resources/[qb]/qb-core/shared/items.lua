...
QBShared.Items = {
    ...
    weed_seed               = { name = 'weed_seed', label = 'Weed Seed', weight = 0, type = 'item', image = 'weed_seed.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'A Basic weed seed' },
    ...
    dust               = { name = 'dust', label = 'Plant Dust', weight = 2000, type = 'item', image = 'weed_nutrition.png', unique = false, useable = true, shouldClose = true, combinable = nil, description = 'Plant nutrition' },
...
vpn = {
    ...
    shouldClose = true,
    combinable = nil,
    description = "What are you gonna do with that?"
},
