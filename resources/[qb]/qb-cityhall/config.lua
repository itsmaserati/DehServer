...
Config.AvailableJobs = {                                     -- Only used when not using qb-jobs.
    ...
    ['pizzadelivery'] = { ['label'] = 'Pizza Delivery Driver', ['isManaged'] = false },
    ['gopostal'] = { ['label'] = 'GoPostal Driver', ['isManaged'] = false },
    ['security'] = { ['label'] = 'Security Officer', ['isManaged'] = false },
