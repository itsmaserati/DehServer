        ...
        Citizen.CreateThread(function()
            while true do
                ...
                if NetworkIsPlayerActive(PlayerId()) then
                    TriggerEvent('qb-spawn:client:setupSpawns', nil, false, nil)
...
RegisterNUICallback('spawn', function(data)
    ...
    if data.type == "lastLocation" then
        ...
        elseif Config.Core == "esx" then
            PreSpawnPlayer()
            ped = PlayerPedId()
            SetEntityCoords(ped, Core.PlayerData.coords.x, Core.PlayerData.coords.y, Core.PlayerData.coords.z)
            SetEntityHeading(ped, ESX.PlayerData.coords.heading)
            FreezeEntityPosition(ped, false)
