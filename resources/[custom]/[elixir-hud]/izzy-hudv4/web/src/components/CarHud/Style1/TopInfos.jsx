...
export default function TopInfos() {
	...
	return (
		<div className='flex'>
			<p className='mt-2.5 translate-x-1 text-sm text-white font-gr-b'>{useRealTime ? moment().format('LT') : time}</p>
			...
			<span className='mt-2.5 -translate-x-1 text-sm text-white font-gr-b'>
				{moment().format('DD')}
