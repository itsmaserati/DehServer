...
-- function Hack( _type, cb, resource, ...)
--     if resource == 'ps-ui' then exports['ps-ui'][_type](_, function(success) cb(success) end, ...) return end
--     if resource == 't3_lockpick' then cb(exports["t3_lockpick"]:startLockpick(...)) return end
-- end
-- -- CIRCLE
-- RegisterCommand("circle", function()
    
-- Hack('Circle', function(success)
--     print(success)
-- end, 'ps-ui', 2, 20)
...
--     exports['ps-ui']:ShowImage("nui://qb-inventory/html/images/beer.png", 5000, 4, 'remove')
-- end) 