...
exports['qb-target']:AddBoxZone('bill', vector3(-1191.49, -894.18, 13.89), 0.6, 0.4,{
    name = 'Bill', debugPoly = false,  heading=345, useZ=true}, {
    options = {{label = 'Bill', icon = 'fa-solid fa-hand-holding', job = Config.Job, action = function() TriggerEvent('ex-burgershot:bill') end}},
    distance = 1.0
})

exports['qb-target']:AddBoxZone('bill2', vector3(-1193.47, -893.63, 13.89), 0.6, 0.4,{
    name = 'Bill2', debugPoly = false,  heading=345, useZ=true}, {
    options = {{label = 'Bill', icon = 'fa-solid fa-hand-holding', job = Config.Job, action = function() TriggerEvent('ex-burgershot:bill') end}},
    distance = 1.0
})

exports['qb-target']:AddBoxZone('bill3', vector3(-1195.47, -893.06, 13.89), 0.65, 0.4,{
    name = 'Bill3', debugPoly = false,  heading=345, useZ=true}, {
    options = {{label = 'Bill', icon = 'fa-solid fa-hand-holding', job = Config.Job, action = function() TriggerEvent('ex-burgershot:bill') end}},
    distance = 1.0
})

exports['qb-target']:AddBoxZone('bill4', vector3(-1197.47, -892.51, 13.89), 0.7, 0.4,{
    name = 'Bill4', debugPoly = false,  heading=345, useZ=true}, {
    options = {{label = 'Bill', icon = 'fa-solid fa-hand-holding', job = Config.Job, action = function() TriggerEvent('ex-burgershot:bill') end}},
    distance = 1.0
})
