...
Config.Locations = {
	...
	{	job = "mechanic",
		...
		stash = { { coords = vec4(-207.1, -1339.9, 30.4, 180.0), w = 3.6, d = 0.6, }, },
		store = { 
			{ coords = vec4(-226.5, -1316.02, 30.3, 180.0), w = 0.85, d = 1.8 },
			{ coords = vec4(-216.34, -1338.98, 31.3, 131.02), w = 3.0, d = 3.0 },
			{ coords = vec4(-216.23, -1338.62, 31.3, 138.27), w = 3.0, d = 3.0 },
			{ coords = vec4(-216.22, -1338.64, 31.3, 122.27), w = 3.0, d = 3.0 },
			{ coords = vec4(-216.22, -1338.64, 31.3, 122.27), w = 3.0, d = 3.0 },
	 	},
		crafting = { { coords = vec4(-217.63, -1332.63, 31.42,88.48), w = 2.8, d = 1.0 }, },
		clockin = { 
			{ coords = vec4(-217.68, -1334.83, 31.07, 87.06), prop = false },
			{ coords = vec4(-197.94, -1317.23, 31.07,272.27), prop = false },
			{ coords = vec4(-192.2, -1315.47, 31.11,272.27), prop = false },
			{ coords = vec4(-195.56, -1316.45, 31.11,181.16), prop = false },
			{ coords = vec4(-218.82, -1337.76, 31.36,262.15), prop = false },
		},
		manualRepair = { { coords = vec4(-194.92, -1323.56, 31.3, 177.25), prop = true, } },
		garage = { spawn = vec4(-182.74, -1317.61, 30.63, 357.23),
					out = vec4(-187.25, -1310.55, 31.3, 270.52),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
					prop = true },
        payments = { coords = vec4(-205.68, -1333.95, 31.1, 285.94),
	...
	{   job = "mechanic",
		...
		clockin = { 
			...
			{ coords = vec4(-1430.43, -454.82, 35.71, 32.0), prop = false, }, 
		},
		manualRepair = { { coords = vec4(-1421.71, -456.21, 35.91, 33.32), prop = false, } },
		garage = { spawn = vec4(-1379.84, -451.82, 34.44, 124.0),
					out = vec4(-1401.57, -451.19, 34.48, 212.71),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" } },
		payments = { coords = vec4(-1429.68, -453.97, 36.03, 27.0),
			img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/0/0c/HayesAutoBodyShop-GTAV-Logo.png width=150px></p>",
			prop = false, },
	...
	{	job = "mechanic",
		...
		garage = { spawn = vec4(163.22, -3009.31, 5.27, 89.72),
					...
					list = { "towtruck", "panto", "slamtruck", "cheburek", "flatbed3", "utillitruck3" },
					prop = true, },
